      ...
      <main className="project-container">
        ...
        <div className="proj-card">
          ...
          <div className="proj-desc">
            <a href='https://www.dirtlessdetailing.com' className='proj-heading-link'>Dirt-Less Detailing</a>
            ...
            <a href="https://www.dirtlessdetailing.com" className="readmore">Dirt-Less Detailing</a>
          </div>
        </div>
