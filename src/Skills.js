  ...
  return (
    <div className="skills" id="skills">
      ...
      <div>
        ...
        <a className="skill-atag" href="https://graphql.org/" target="_blank" rel="noopener noreferrer"><img className="skill-icon-img" src={graphQL} alt="mongodb logo"/></a>
        <a className="skill-atag" href="https://nodejs.org/en/" target="_blank" rel="noopener noreferrer"><img className="skill-icon-img" src={nodeJS} alt="mongodb logo"/></a>
        <a className="skill-atag" href="https://www.mongodb.com/" target="_blank" rel="noopener noreferrer"><img className="skill-icon-img" src={mongoDB} alt="mongodb logo"/></a>
